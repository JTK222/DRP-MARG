...
public class LogHelper {
	...
	static {
		try {
			...
			File	file	= new File(e, "marg-latest.log");
			File	lock	= new File(e, "marg-latest.log.lck");
			File	file1	= new File(e, "marg-1.log");
			File	file2	= new File(e, "marg-2.log");
			File	file3	= new File(e, "marg-3.log");
			if(lock.exists()) {
				lock.delete();
			}
